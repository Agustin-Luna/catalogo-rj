...
const ItemCard = ({ item }) => {
  return (
    <div className="w-80  h-full mb-4">
      <article className="hover:shadow-lg transition duration-300 ease-in-out transform hover:scale-105 bg-pink-600 border border-gray-300 rounded-md p-4 h-96 ">
